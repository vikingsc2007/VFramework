...
//					#if UNITY_EDITOR
//					if (packagePath!=null && UIPackage.GetByName(packageName) == null)
...
//					#endif
					if(packageName!=null && UIPackage.GetByName(packageName) == null)
						FairyGUIEx.FairyGUIUtils.AddPackage(packageName);
