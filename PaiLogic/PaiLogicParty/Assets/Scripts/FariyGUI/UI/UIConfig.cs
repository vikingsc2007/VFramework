	...
	public class UIConfig : MonoBehaviour
	{
		...
		void Awake()
		{
			if (Application.isPlaying)
			{
				...
				{
//					UIPackage.AddPackage (PTGame.AssetBundles.PTResourceManager.Instance.LoadAssetBundleAsync(packagePath.,(bool success,AssetBundle ab)=>{
//						
//					}));
//					#if UNITY_EDITOR
//					UIPackage.AddPackage(packagePath, (string name, string extension, System.Type type) => { return UnityEditor.AssetDatabase.LoadAssetAtPath(name+extension, type); });
//					#else
//					UIPackage.AddPackage(packagePath);
//					#endif
					if(packagePath!=null && UIPackage.GetByName(packagePath) == null)
						FairyGUIEx.FairyGUIUtils.AddPackage(packagePath);
//					UIPackage.AddPackage(packagePath);
				}
