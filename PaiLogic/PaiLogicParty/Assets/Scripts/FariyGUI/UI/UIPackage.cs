...
namespace FairyGUI
{
	...
	public class UIPackage
	{
		...
		public static bool UseABAsset = false;
		...
		/// <summary>
		/// Added by maoling: Add a UI package from a path using AssetDatabase.LoadAssetAtPath
		/// </summary>
		/// <returns>UIPackage</returns>
		#if UNITY_EDITOR	
		public static UIPackage AddPackageFromAssetDatabase(string descFilePath)
		{
